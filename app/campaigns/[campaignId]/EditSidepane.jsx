										...
										<div className='px-4 py-6 sm:px-6'>
											<div className='flex items-start justify-between'>
												...
												<div className='ml-3 flex h-7 items-center'>
													<button type='button' className='relative rounded-md bg-white text-gray-400 hover:text-gray-500 focus:ring-2 focus:ring-indigo-500' onClick={() => setOpen(false)}>
										...
										<div>
													...
													<div className='mt-6 px-4 sm:mt-8 sm:flex sm:items-end sm:px-6'>
														<div className='sm:flex-1'>
															...
															<div className='mt-5 flex flex-wrap space-y-3 sm:space-x-3 sm:space-y-0'>
																...
																<button type='button' className='inline-flex w-full flex-1 items-center justify-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50'>
																	Edit
																</button>
											...
											<div className='px-4 pb-5 pt-5 sm:px-0 sm:pt-0'>
												<dl className='space-y-8 px-4 sm:space-y-6 sm:px-6'>
													...
													<div>
														<dt className='text-sm font-medium text-gray-500 sm:w-40 sm:flex-shrink-0'>Subject</dt>
														<dd className='mt-1 text-sm text-gray-900 sm:col-span-2'>{play.subject}</dd>
													</div>
													<div>
